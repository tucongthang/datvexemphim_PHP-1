...
<section id="aboutUs">
    <div class="container">
        <div class="heading text-left">
            ...
            <div class="wel_line">
                <center><h3>WELCOME TO AZIR Cinema </h3></center>
            </div>
        </div>
        <div class="row feature design">
            ...
            <div class="area2 columns feature-media left"><img
                        src="assets/images/Online-Movie-Ticket-Booking-Banner-1-1280x720.jpg" alt="" width="100%"></div>
        </div>
    ...
    <div class="PatronStruc">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="dvPatron">
                    <img src="assets/images/hall.jpg" class="resize" alt="#"/>
