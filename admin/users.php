  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_users_modal" class="btn btn-primary btn-sm">Thêm</a>
      	</div>
      </div>
...
<!--              <td><img src="../upload/--><?php //echo $row['image']; ?><!--" alt="" class="resize"></td>-->
        <td><?php echo $row['image'] ?></td>
              <td><button data-toggle="modal" type="button" data-target="#edit_users_modal<?php echo $id;?>" class="btn btn-primary btn-sm">Chỉnh sửa</button>
              <button data-toggle="modal" type="button" data-target="#delete_users_modal<?php echo $id;?>" class="btn btn-danger btn-sm">Xóa</button></td></td>
            </tr>
